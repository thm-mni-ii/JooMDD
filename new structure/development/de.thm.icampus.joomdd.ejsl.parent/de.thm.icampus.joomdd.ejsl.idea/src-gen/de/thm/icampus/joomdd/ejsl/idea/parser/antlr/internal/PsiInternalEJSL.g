	...
	(
		...
		(
			(
				...
				lv_autoincrement_5_0='Auto Increment'
				{
		...
		(
			...
			(
				(
					...
					lv_descripton_18_0=RULE_STRING
					{
						if(!$current) {
							associateWithSemanticElement();
							$current = true;
...
entryRuleDatapackage returns [Boolean current=false]:
...
// Rule Datapackage
ruleDatapackage returns [Boolean current=false]
:
	(
		(
			{
		...
		(
			...
			(
				(
					...
					lv_authoremail_6_0=RULE_STRING
					{
						if(!$current) {
							associateWithSemanticElement();
							$current = true;
		...
		(
			...
			(
				(
					...
					lv_type_8_0=RULE_POSITION_TYPES_NAMES
					{
						if(!$current) {
							associateWithSemanticElement();
							$current = true;
...
ruleSectionReference returns [Boolean current=false]
:
	(
		(
			{
