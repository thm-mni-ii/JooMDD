...
public static val AMBIGUOUS_ATTRIBUTE_NAME = 'ambiguousAttrName'
	 ...
	 */
	@Check
	def checkComponentLanguageIsUnique(de.thm.icampus.ejsl.eJSL.Extension ext) {
        ...
        for(filt : p.filters){
            ...
            if(!p.entities.contains(enti)){
                error(
                        ...
                        p,
                        EJSLPackage.Literals.DYNAMIC_PAGE__FILTERS.getEOpposite,
        ...
        for(column : p.tablecolumns){
            ...
            if(!p.entities.contains(enti)){
                error(
                        ...
                        p,
                        EJSLPackage.Literals.DYNAMIC_PAGE__TABLECOLUMNS.getEOpposite,
