...
public class EJSLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == EJSLPackage.eINSTANCE)
			...
			case EJSLPackage.CMS_CORE:
				sequence_CMSCore(context, (CMSCore) semanticObject); 
				return; 
			case EJSLPackage.CMS_EXTENSION:
				sequence_CMSExtension(context, (CMSExtension) semanticObject); 
				return; 
			...
			case EJSLPackage.ENTITYPACKAGE:
				sequence_Entitypackage(context, (Entitypackage) semanticObject); 
				return; 
			...
			case EJSLPackage.PAGE_ACTION:
				sequence_PageAction(context, (PageAction) semanticObject); 
				return; 
			...
			case EJSLPackage.CORE_FEATURE:
				sequence_coreFeature(context, (coreFeature) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (name=MYID type=Type (isunique?='Unique attribute' (withattribute=[Attribute|QualifiedName] | id?='ID')?)?)
	 */
	...
	/**
	 * Contexts:
	 *     EJSLPart returns CMSCore
	 *     CMSCore returns CMSCore
	 *
	 * Constraint:
	 *     ((datatypes+=Datatype datatypes+=Datatype*)? globalparameters+=Parameter* parametergroups+=ParameterGroup* feature=Feature)
	 */
	protected void sequence_CMSCore(ISerializationContext context, CMSCore semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     EJSLPart returns CMSExtension
	 *     CMSExtension returns CMSExtension
	 *
	 * Constraint:
	 *     ((datatypes+=Datatype datatypes+=Datatype*)? globalparameters+=Parameter* parametergroups+=ParameterGroup* feature=Feature extensions+=Extension*)
	 */
	protected void sequence_CMSExtension(ISerializationContext context, CMSExtension semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_CustomPage(ISerializationContext context, CustomPage semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=STRING ejslPart=EJSLPart)
	 */
	protected void sequence_EJSLModel(ISerializationContext context, EJSLModel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EJSLPackage.Literals.EJSL_MODEL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EJSLPackage.Literals.EJSL_MODEL__NAME));
			if (transientValues.isValueTransient(semanticObject, EJSLPackage.Literals.EJSL_MODEL__EJSL_PART) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EJSLPackage.Literals.EJSL_MODEL__EJSL_PART));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEJSLModelAccess().getNameSTRINGTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getEJSLModelAccess().getEjslPartEJSLPartParserRuleCall_4_1_0(), semanticObject.getEjslPart());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID entitypackages+=Entitypackage* entities+=Entity* datatypes+=Datatype*)
	 */
	protected void sequence_Entitypackage(ISerializationContext context, Entitypackage semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (target=STRING linkedAttribute=[Attribute|QualifiedName]? linkedAction=[PageAction|QualifiedName]? label=STRING?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (entitypackages+=Entitypackage* entities+=Entity* pages+=Page* sections+=Section*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=MYID target=[Page|QualifiedName] linkedAttribute=[Attribute|QualifiedName]? linkedAction=[PageAction|QualifiedName]?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=MYID (attvalue=[Attribute|STRING] | id?='ID' | value=STRING))
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID pageActionType=PageActionKind pageActionPosition=PageActionPositionKind)
	 */
	protected void sequence_PageAction(ISerializationContext context, PageAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EJSLPackage.Literals.PAGE_ACTION__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EJSLPackage.Literals.PAGE_ACTION__NAME));
			if (transientValues.isValueTransient(semanticObject, EJSLPackage.Literals.PAGE_ACTION__PAGE_ACTION_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EJSLPackage.Literals.PAGE_ACTION__PAGE_ACTION_TYPE));
			if (transientValues.isValueTransient(semanticObject, EJSLPackage.Literals.PAGE_ACTION__PAGE_ACTION_POSITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EJSLPackage.Literals.PAGE_ACTION__PAGE_ACTION_POSITION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPageActionAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getPageActionAccess().getPageActionTypePageActionKindEnumRuleCall_5_0(), semanticObject.getPageActionType());
		feeder.accept(grammarAccess.getPageActionAccess().getPageActionPositionPageActionPositionKindEnumRuleCall_7_0(), semanticObject.getPageActionPosition());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (page=[Page|QualifiedName] (pagescr=[Component|QualifiedName] sect=SectionKinds)?)
	 */
	...
	/**
	 * Contexts:
	 *     coreFeature returns coreFeature
	 *
	 * Constraint:
	 *     {coreFeature}
	 */
	protected void sequence_coreFeature(ISerializationContext context, coreFeature semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
