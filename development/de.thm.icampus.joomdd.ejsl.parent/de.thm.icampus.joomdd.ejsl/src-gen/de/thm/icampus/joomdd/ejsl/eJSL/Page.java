 ...
 *   <li>{@link de.thm.icampus.joomdd.ejsl.eJSL.Page#getPageactions <em>Pageactions</em>}</li>
...
public interface Page extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Pageactions</b></em>' containment reference list.
   * The list contents are of type {@link de.thm.icampus.joomdd.ejsl.eJSL.PageAction}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Pageactions</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Pageactions</em>' containment reference list.
   * @see de.thm.icampus.joomdd.ejsl.eJSL.EJSLPackage#getPage_Pageactions()
   * @model containment="true"
   * @generated
   */
  EList<PageAction> getPageactions();
