...
public class PageGeneratorHandler {
	...
	private def  void generateStaticPage(ExtendedStaticPage sp) {
		var de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.StaticPageTemplate static = new de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.StaticPageTemplate(sp,com,sectionExt,pathExt,fsa)
		static.generate
	}
	...
	private def  void generateView(ExtendedDynamicPage page, ExtendedComponent component, String sec, String path,IFileSystemAccess2 fsa) {
	    if(page.detailsPage) {
	        var de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplate dp = new de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplate(page, component, sec, path, fsa)
			dp.generateView()
		} else {
			var de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.IndexPageTemplate dp = new de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.IndexPageTemplate(page, component, sec, path, fsa)
			dp.generateView()
		}
	}
