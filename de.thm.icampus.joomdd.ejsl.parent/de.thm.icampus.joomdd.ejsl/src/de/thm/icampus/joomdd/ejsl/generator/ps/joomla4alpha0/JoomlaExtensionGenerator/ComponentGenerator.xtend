package de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaExtensionGenerator;
...
import de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.EntityGenerator
import de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaUtil.LanguageGenerator
import de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaUtil.Slug
import de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.PageGenerator
...
public class ComponentGenerator extends AbstractExtensionGenerator {
	...
	private def void generateBackendSection() {
		...
		var de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaExtensionGenerator.ComponentHelperGenerator help = new de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaExtensionGenerator.ComponentHelperGenerator(extendedComp)
