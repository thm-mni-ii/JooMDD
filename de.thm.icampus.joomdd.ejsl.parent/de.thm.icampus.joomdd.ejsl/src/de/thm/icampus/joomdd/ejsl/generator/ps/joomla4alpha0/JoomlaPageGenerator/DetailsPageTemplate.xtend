 ...
 */
class DetailsPageTemplate extends   de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DynamicPageTemplate {
	
	private ExtendedDynamicPage dpage
	private ExtendedComponent  com
	private String sec
	private de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplateBackendHelper backHelp
	private de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplateFrontEndHelper frontHelp
	private String path
	...
	new(ExtendedDynamicPage dp, ExtendedComponent cp, String section, String path,IFileSystemAccess2 fsa) {
		...
		com = cp
		sec = section
		backHelp = new   de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplateBackendHelper(dpage, com, sec)
		frontHelp = new   de.thm.icampus.joomdd.ejsl.generator.ps.joomla4alpha0.JoomlaPageGenerator.DetailsPageTemplateFrontEndHelper(dpage, com, sec)
		this.path = path
