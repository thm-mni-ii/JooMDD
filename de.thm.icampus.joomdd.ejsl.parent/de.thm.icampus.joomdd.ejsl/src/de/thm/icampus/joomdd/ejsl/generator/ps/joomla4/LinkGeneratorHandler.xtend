	...
	public def CharSequence generateLink(){
		switch link {
			...
			if(link instanceof ContextLink) {
				var de.thm.icampus.joomdd.ejsl.generator.ps.joomla4.JoomlaPageGenerator.ContextLinkGenerator intern = new de.thm.icampus.joomdd.ejsl.generator.ps.joomla4.JoomlaPageGenerator.ContextLinkGenerator(link,valueF)
